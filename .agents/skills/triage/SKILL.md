...
Read `AGENTS.md` sections on Project Principles and Non-Goals.
...
- AGENTS.md roadmap for what's planned vs out of scope
...
- **Code style**: Does it follow conventions in AGENTS.md?
